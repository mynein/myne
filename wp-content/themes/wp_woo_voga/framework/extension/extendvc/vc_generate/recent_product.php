...
$recent_product_by_category_params = array(
	"name" => "WD Recent Products",
	"base" => "recent_product_by_categories",
	...
	"params" => array(		
		...
		array(
			"type" => "dropdown",
			"class" => "",
			"heading" => __("Show load more", "wpdance"),
			"admin_label" => true,
			...
			"description" => __("Show loadmore button", "wpdance")
		),
		array(
			"type" => "textfield",
			"class" => "",
			"heading" => __("Button load more text", "wpdance"),
			"admin_label" => true,
			"param_name" => "bt_load_more_text",
			"value" => "",
			"description" => __("Ex: Load more", "wpdance")
		),
