...
<ul id="bbp-search-results" class="forums bbp-search-results">
	...
	<li class="bbp-header">
		...
		<div class="bbp-search-author"><?php  _e( 'Author',  'wpdance' ); ?></div><!-- .bbp-reply-author -->

		<div class="bbp-search-content">

			<?php _e( 'Search Results', 'wpdance' ); ?>
	...
	<li class="bbp-footer">
		...
		<div class="bbp-search-author"><?php  _e( 'Author',  'wpdance' ); ?></div>
