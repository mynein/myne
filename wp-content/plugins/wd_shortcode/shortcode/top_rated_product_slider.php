<?php
if(!function_exists('wd_top_rated_slider_function')){
		function wd_top_rated_slider_function($atts,$content){
			...
			if ( $products->have_posts() ) : ?>
				...
				<div class="top-rated-product-sc shortcode-slider shortcode-product <?php echo $show_type ?> <?php echo $extra_class_row ?> <?php echo (strlen(trim($big_product)) > 0)?' big_product':'' ?>" id="<?php echo $_random_id;?>">
	...
	add_shortcode('top_rated_product_slider','wd_top_rated_slider_function');	
?>