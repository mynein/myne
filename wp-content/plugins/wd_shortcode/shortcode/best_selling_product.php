<?php 
if(!function_exists ('wd_best_selling_product')){
	function wd_best_selling_product($atts,$content = null) {
		$_actived = apply_filters( 'active_plugins', get_option( 'active_plugins' )  );
			...
			if ( $products->have_posts() ) : ?>
				<div class="best-selling-product-sc shortcode-product <?php echo $show_type ?>">
...
add_shortcode('best_selling_product','wd_best_selling_product');
?>