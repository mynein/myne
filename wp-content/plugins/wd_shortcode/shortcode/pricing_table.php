...
if (!function_exists('wd_ptable_shortcode')) {
	function wd_ptable_shortcode($atts, $content = null) {
        ...
        if($target == ""){
         ...
         if($active == "yes"){
            $html .= "<div class='wd_price_table active_price'><span class='label_active'>".$label_active."</span>";
        } else {
        ...
        $html .= "<span class='pricing'>".$currency.$price."</span>";
	    ...
	    $html .= "<a class='button big' href='$link' target='$target'>".$button_text."</a>";
