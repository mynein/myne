<?php 
if(!function_exists ('wd_top_rated_product')){
	function wd_top_rated_product($atts,$content = null) {
		$_actived = apply_filters( 'active_plugins', get_option( 'active_plugins' )  );
			...
			if ( $products->have_posts() ) : ?>
				<div class="top-rated-product-sc shortcode-product <?php echo $show_type ?>">
...
add_shortcode('top_rated_product','wd_top_rated_product');
?>