...
if(!function_exists('wd_featured_product_slider_function')){
	function wd_featured_product_slider_function($atts,$content){
		...
		if ( $products->have_posts() ) : ?>
			...
			<div class="feature-product-sc shortcode-slider shortcode-product <?php echo $show_type ?> <?php echo $extra_class_row ?> <?php echo (strlen(trim($big_product)) > 0)?'big_product':'' ?>" id="<?php echo $_random_id;?>">
				...
				?>
				<div class="<?php echo $show_type; ?> product-slider-wrapper <?php echo $extra_class ?>">	
